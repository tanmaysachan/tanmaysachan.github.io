...
This sounds an awful lot like a solution for the halting problem.
...
(Not going into how the upper bound was lowered to an oddly specific 748, because I do not understand it.)

ZFC is the standard set of axioms that we base our mathematics on. It is a set of axioms that we believe
...
is Godel's second incompleteness theorem.
...
one by one. By Godel's theorem, ZFC can't prove if this machine will ever halt, as we just read above. The authors
